        ...
        <div className="w-screen h-screen bg-cover  bg-center bg-mobile sm:bg-site z-10 relative" >
          {/* Aca iria una pequeña animacion  */}
            {/* <motion.div> */}
              ...
              <h1 className="h1 z-10 absolute mix-blend-color-dodge text-primary  top-[40px] left-[26%] sm:left-[26%] xl:left-[38%]"><span className="leading-[80px] tracking-[4px]">Catalogo</span></h1>
